<?php
// src/View/contenu_seance/add.php
// Vue pour le formulaire d'ajout d'un contenu de séance
?>
...
<div class="container mt-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="<?= BASE_URL ?>/contenus-seance/store" method="POST" class="needs-validation" novalidate>
