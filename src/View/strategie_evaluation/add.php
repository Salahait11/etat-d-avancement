<?php
// src/View/strategie_evaluation/add.php
// Vue pour le formulaire d'ajout d'une stratégie d'évaluation
?>
...
<div class="container mt-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="<?= BASE_URL ?>/strategies-evaluation/store" method="POST" class="needs-validation" novalidate>
