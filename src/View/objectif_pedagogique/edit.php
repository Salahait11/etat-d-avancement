<?php
// src/View/objectif_pedagogique/edit.php
// Vue pour le formulaire d'édition d'un objectif pédagogique
?>
...
<div class="container mt-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="<?= BASE_URL ?>/objectifs-pedagogiques/update/<?= $objectif['id'] ?>" method="POST" class="needs-validation" novalidate>
