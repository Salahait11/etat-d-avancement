<?php
// src/View/utilisateur/create.php
// Vue pour le formulaire d'ajout d'un utilisateur
?>
...
<div class="container mt-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="<?= BASE_URL ?>/utilisateurs/store" method="POST" class="needs-validation" novalidate>
                <div class="row mb-3">
                    <div class="col-md-6">
