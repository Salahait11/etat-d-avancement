<?php
// src/View/moyen_didactique/add.php
// Vue pour le formulaire d'ajout d'un moyen didactique
?>
...
<div class="container mt-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="<?= BASE_URL ?>/moyens-didactiques/store" method="POST" class="needs-validation" novalidate>
