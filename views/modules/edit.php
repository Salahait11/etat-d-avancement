...
<div class="container-fluid px-4">
    <h1 class="mt-4">Modifier le Module</h1>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="/modules/update/<?= $module['id'] ?>" method="POST" class="needs-validation" novalidate>
                <div class="row mb-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="nom" name="nom" required
                               ...
                               value="<?= htmlspecialchars($module['nom']) ?>">
                        <div class="invalid-feedback">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="3"
                              maxlength="500"><?= htmlspecialchars($module['description']) ?></textarea>
                    <div class="form-text">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="duree" name="duree" required
                               ...
                               value="<?= htmlspecialchars($module['duree']) ?>">
                        <div class="invalid-feedback">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" 
                                           ...
                                           <?= in_array($competence['id'], $moduleCompetences) ? 'checked' : '' ?>>
                ...
                <div class="d-flex justify-content-between">
                    <a href="/modules/<?= $module['id'] ?>" class="btn btn-secondary">
